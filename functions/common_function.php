    ...
    while($row=mysqli_fetch_assoc($result_query)){
        ...
        <div class='card'>
            ...
            <div class='card-body'>
                ...
                <p class='card-text'>Price:Rp. $product_price/-</p>
...
while($row_data=mysqli_fetch_assoc($result_categories)){
 ...
 // get searching product function
 ...
 function search_product($con){
    ...
    if($num_of_rows==0){
        ...
        No product found on this category.!</h2>";
    }
...
if(isset($_GET['add_to_cart'])){
    ...
    '$get_ip_add' and product_id=$get_product_id";
    $result_query=mysqli_query($con,$select_query);
    $num_of_rows=mysqli_num_rows($result_query);
    if($num_of_rows>0){
        ...
        echo "<script>alert('Item is added to carts')
        </script>";
        echo "<script>window.open('index.php','_self')</script>";
    }
}
    ...
    while($row_query=mysqli_fetch_array($result_query)){
        ...
        if(!isset($_GET['edit_account'])){
            ...
            if(!isset($_GET['delete_account'])){
                ...
                if($row_count>0){
                    echo "<h3 class='text-center text-success my-5 mb-2'>You have 
