...
<head>
    ...
    <title>Mandiri Jaya Store - Cart Detail</title>
...
<!--third child -->
<div class="bg-light">
    <h3 class="text-center">Whistlist Cart</h3>
    ...
    <div class="row">
        ...
        <table class="table table-bordered text-center">
             ...
             $total_price+=$product_values;
                ...
                <tr>
                    ...
                    class="form-input w-50" value="<?php echo $row ['quantity']; ?>"></td>
                    <?php 
                    $get_ip_add = getIPAddress();
                    ...
                    <td>
                        ...
                        class="bg-info px-3 py-2 border-0 mx-2" name="update_cart">
                    
                        <input type="submit" value="Remove Cart"
                        class="bg-info px-3 py-2 border-0 mx-2" name="remove_cart">
        ...
        <div class="d-flex mb-3">
            <?php 
             ...
             if($result_count>0)
             {
                echo" <h4 class='px-3'>Subtotal:<strong class='text-info'>Rp. $total_price</strong></h4>
            <input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 border-0 mx-2' name='continue_shopping'>
        
            <button class='bg-secondary px-3 py-2 border-0'><a href='./user_area/checkout.php?from=checkout'
            class='text-light text-decoration-none'>Checkout</a></button>";
             }else{
                echo "<input type='submit' value='Continue Shopping'
                class='bg-info px-3 py-2 border-0 mx-2' name='continue_shopping'>
            ";
             }
...
function remove_cart_item($con){
    if(isset($_POST['remove_cart'])){
      if(isset($_POST['removeitem'])){
        ...
        echo "<script>alert('Mohon Pilih Produk')</script>";
      }
    }
}
echo $remove_item=remove_cart_item($con);
